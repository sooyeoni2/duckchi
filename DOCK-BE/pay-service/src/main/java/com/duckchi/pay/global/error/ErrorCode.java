...
public enum ErrorCode {
    ...
    // FINANCE
    FINANCE_API_ERROR("FINANCE-502-1", HttpStatus.BAD_GATEWAY, "외부 금융 서비스와 통신 중 오류가 발생했습니다."),
    ...
    // ROOM
    ROOM_SESSION_MISMATCH("ROOM-400-4", HttpStatus.BAD_REQUEST, "해당 회차가 요청한 모임방에 속하지 않습니다."),
    ROOM_PARTICIPANT_NOT_FOUND("ROOM-404-2", HttpStatus.NOT_FOUND, "모임에 참여하지 않은 사용자가 포함되어 있습니다."),
    ROOM_MEMBER_ONLY("ROOM-403-1", HttpStatus.FORBIDDEN, "해당 모임의 멤버만 접근할 수 있습니다."),
    ROOM_NOT_FOUND("ROOM-404-1", HttpStatus.NOT_FOUND, "모임방을 찾을 수 없습니다."),
    ...
    ROOM_CANNOT_UPDATE_STATUS("ROOM-409-4", HttpStatus.CONFLICT, "정산 진행 중인 모임은 정보를 수정할 수 없습니다."),
    ROOM_ADMIN_DELEGATION_REQUIRED("ROOM-409-5", HttpStatus.CONFLICT, "방장은 방장 권한을 위임해야 모임을 나갈 수 있습니다."),
    ROOM_CANNOT_LEAVE_PROGRESS("ROOM-409-6", HttpStatus.CONFLICT, "정산 진행 중인 모임은 나갈 수 없습니다."),
    ROOM_CANNOT_DELETE_PROGRESS("ROOM-409-7", HttpStatus.CONFLICT, "정산 진행 중인 모임은 삭제할 수 없습니다.");
