...
import App from './App';
const recentBackgroundMessageIds = new Set();
...
messaging().setBackgroundMessageHandler(async (remoteMessage) => {
  ...
  if (
    ...
    recentBackgroundMessageIds.has(remoteMessage.messageId)
  ) {
    return;
  }

  if (remoteMessage.messageId != null) {
    recentBackgroundMessageIds.add(remoteMessage.messageId);

    setTimeout(() => {
      recentBackgroundMessageIds.delete(remoteMessage.messageId);
    }, 30000);
  }
