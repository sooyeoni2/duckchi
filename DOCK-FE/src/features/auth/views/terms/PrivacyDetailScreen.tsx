...
type Props = NativeStackScreenProps<AuthStackParamList, 'PrivacyDetail'>;
...
export function PrivacyDetailScreen({ route, navigation }: Props) {
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <View style={styles.buttonWrapper}>
        ...
        >
          <Text style={styles.confirmText}>동의하기</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
